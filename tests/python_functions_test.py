...
class TestPythonFunctionPractice(unittest.TestCase):
  ...
  def test_reverse_string(self):
    test_string = "word"
    reversed_string_result = reversed_string(test_string)
    self.assertEqual( "drow", reversed_string_result )


  #Given a value in farenheit, convert this into celsius.
 
  def test_fahrenheit_to_celsius(self):
    fh_to_c_result = fh_to_c(56)
    self.assertAlmostEqual(13, fh_to_c_result)
